...
const heroPattern = /(<main id="contenuto">\s*)<section[\s\S]*?<\/section>/;
if (!heroPattern.test(html)) throw new Error('Homepage first section target not found.');
html = html.replace(heroPattern, `$1${hero}`);
