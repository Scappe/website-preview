...
const logo = '/assets/media/axante-logo.png';
const media = {
  casarossa: '/assets/media/casarossa.jpg',
  unicart: '/assets/media/unicart.jpg',
  carabetta: '/assets/media/carabetta.jpg',
  carabettaLogo: '/assets/media/carabetta-logo.png',
  weblab: '/assets/media/weblab.jpg',
  tda: '/assets/media/tda.jpg'
};
...
<link rel="preload" as="image" href="${media.casarossa}">
<link rel="stylesheet" href="/home-v5.css?v=6.0">
...
<body>
<div class="page-transition" aria-hidden="true"><span>AXANTE</span></div>
...
<div class="tap-effects" aria-hidden="true"></div>
<a class="skip-link" href="#contenuto">Vai al contenuto</a>
<header class="site-header">
  <div class="container nav-wrap">
    <a class="brand" data-magnetic href="/" aria-label="Axante, torna all’inizio"><img src="${logo}" width="198" alt="Axante"></a>
...
<main id="contenuto">
<section class="hero">
  <div class="mobile-status" aria-hidden="true"><i></i><span>AXANTE SYSTEM</span><b>06 / LIVE</b></div>
  <div class="container hero-grid">
    ...
    <div class="hero-art reveal" aria-label="Progetti reali realizzati da Axante">
      ...
      <figure class="project-frame project-main" data-depth="1.1" data-tilt data-project="Casa Rossa"><img src="${media.casarossa}" width="1200" height="900" fetchpriority="high" decoding="async" alt="Casa Rossa, e-commerce realizzato da Axante"></figure>
      <figure class="project-frame project-satellite" data-depth="1.8" data-tilt data-project="Unicart Auctions"><img src="${media.unicart}" width="900" height="650" decoding="async" alt="Unicart Auctions"></figure>
      <div class="project-badge" data-depth="2.2"><small>Brand nel portfolio</small><img src="${media.carabettaLogo}" width="230" decoding="async" alt="Carabetta"></div>
      <div class="floating-code" data-depth="2.5"><b>01</b> strategy<br><b>02</b> design<br><b>03</b> technology</div>
      <div class="mobile-orbit-copy" aria-hidden="true"><span>DESIGN</span><span>GROWTH</span><span>TECH</span></div>
    </div>
  </div>
</section>
...
<section class="section capabilities">
  <div class="container">
    <div class="section-head"><div><span class="eyebrow reveal">Un solo partner, molte competenze</span><h2 class="reveal">Non un catalogo.<br><span class="gradient">Un universo operativo.</span></h2></div><p class="reveal">Tocca o passa sulle competenze. Ogni progetto combina soltanto ciò che serve per trasformare un problema in un risultato misurabile.</p></div>
    <div class="capability-shell">
      ...
      <div class="capability-stage reveal" data-capability-stage>
        ...
        <a class="capability-node node-web active" href="/siti-web" data-index="01" data-title="Siti ed e-commerce" data-short="Esperienze digitali che convertono." data-copy="Strategia, UX, copy, sviluppo, SEO tecnica, tracciamento e integrazioni: dal primo clic alla conversione." data-href="/siti-web"><span class="node-media"><img src="${media.unicart}" loading="lazy" decoding="async" alt="Web ed e-commerce"></span><b>Web & commerce</b></a>
        <a class="capability-node node-brand" href="/branding" data-index="02" data-title="Brand e design" data-short="Identità che diventano memoria." data-copy="Logo, sistemi visivi, grafica, packaging e materiali capaci di rendere il brand riconoscibile prima ancora di leggerne il nome." data-href="/branding"><span class="node-media"><img src="${media.carabetta}" loading="lazy" decoding="async" alt="Brand e design"></span><b>Brand & design</b></a>
        <a class="capability-node node-growth" href="/marketing" data-index="03" data-title="Growth e contenuti" data-short="Attenzione trasformata in domanda." data-copy="SEO, campagne, social, foto, video e funnel collegati a metriche reali, non a numeri vanitosi." data-href="/marketing"><span class="node-media"><img src="${media.tda}" loading="lazy" decoding="async" alt="Marketing e contenuti"></span><b>Growth & content</b></a>
        <a class="capability-node node-tech" href="/sviluppo" data-index="04" data-title="Tech e automazioni" data-short="La complessità lavora dietro le quinte." data-copy="Applicazioni, plugin, gestionali e automazioni su misura per eliminare attriti, errori e attività ripetitive." data-href="/sviluppo"><span class="node-media"><img src="${media.weblab}" loading="lazy" decoding="async" alt="Sviluppo e automazioni"></span><b>Tech & automation</b></a>
      </div>
    </div>
  </div>
</section>
...
<section class="project-reel" data-horizontal>
  <div class="sticky-projects">
    ...
    <div class="project-track">
      <article class="reel-card" data-mobile-depth data-project="Casa Rossa"><img src="${media.casarossa}" width="1400" height="1000" loading="lazy" decoding="async" alt="Casa Rossa"><a class="reel-link" href="/portfolio#casarossa" aria-label="Apri Casa Rossa">↗</a><div class="reel-content"><div class="tags"><span>E-commerce</span><span>Multilingua</span><span>Development</span></div><h3>Casa Rossa</h3><p>Un’eccellenza siciliana trasformata in un’esperienza internazionale di racconto, prodotto e acquisto.</p></div></article>
      <article class="reel-card" data-mobile-depth data-project="Unicart Auctions"><img src="${media.unicart}" width="1400" height="1000" loading="lazy" decoding="async" alt="Unicart Auctions"><a class="reel-link" href="/portfolio#unicart" aria-label="Apri Unicart Auctions">↗</a><div class="reel-content"><div class="tags"><span>Marketplace</span><span>Aste online</span><span>UX/UI</span></div><h3>Unicart Auctions</h3><p>Una piattaforma complessa resa semplice da usare, capire e far crescere.</p></div></article>
      <article class="reel-card" data-mobile-depth data-project="Carabetta"><img src="${media.carabetta}" width="1400" height="1000" loading="lazy" decoding="async" alt="Carabetta"><a class="reel-link" href="/portfolio#carabetta" aria-label="Apri Carabetta">↗</a><div class="reel-content"><div class="tags"><span>Fashion</span><span>E-commerce</span><span>Brand experience</span></div><h3>Carabetta</h3><p>Un’esperienza editoriale elegante che accompagna la collezione verso la conversione.</p></div></article>
      <article class="reel-card" data-mobile-depth data-project="Tracciati d’Arte"><img src="${media.tda}" width="1400" height="1000" loading="lazy" decoding="async" alt="Tracciati d’Arte"><a class="reel-link" href="/portfolio#tda" aria-label="Apri Tracciati d’Arte">↗</a><div class="reel-content"><div class="tags"><span>Magazine</span><span>Art direction</span><span>Content</span></div><h3>Tracciati d’Arte</h3><p>Un ecosistema editoriale che mette opere, autori e lettura al centro della scena.</p></div></article>
    </div>
  </div>
</section>
...
<script src="/home-v5.js?v=6.0" defer></script>
</body></html>`;

fs.writeFileSync(path.join(site, 'index.html'), html);
console.log('Generated hardened cinematic Axante v6 homepage.');
